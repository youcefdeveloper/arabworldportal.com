...
const texts = {
    ar: {
        dir: 'rtl',
        logo: 'بوابة العالم العربي',
        copyright: 'بوابة العالم العربي © 2025',
        title: 'الموقع قيد الإنشاء',
        text1: 'نحن نعمل على إطلاق بوابة بوابة العالم العربي قريباً.',
    ...
    en: {
        dir: 'ltr',
        logo: 'Arab World Portal',
        copyright: 'Arab World Portal © 2025',
        title: 'Website Under Construction',
        text1: 'We are working on launching Arab World Portal soon.',
